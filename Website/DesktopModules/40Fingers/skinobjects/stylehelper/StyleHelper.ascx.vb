...
#Region "General"
        ...
        Private Function CheckConditions() As Boolean
            ...
            Return CheckBrowsers(IfBrowser) AndAlso
            CheckUser(IfUserName) AndAlso
            CheckUserMode(IfUserMode) AndAlso
            CheckURLs(IfURL) AndAlso
            CheckCultures(IfCulture) AndAlso
            CheckUserAgents(IfUserAgentString) AndAlso
            CheckRoles(IfRole) AndAlso
            CheckQueryString(IfQS) AndAlso
            CheckTextDir(IfTextDir) AndAlso
            CheckMobile() AndAlso
...
#Region "Helper Functions"
        ...
        Private Function ProcessTokens(ByVal sOriginal As String, Type As TextType) As String
            ...
            'As these are calculated alues, first check if there is a match for the Token
            ...
            If MatchToken(sOriginal, "[PageType]") Then
                sOriginal = ReplaceToken(sOriginal, "[PageType]", GetPageType, Type)
            End If
        ...
        Private Function ReplaceToken(Original As String, Token As String, Value As String, Type As TextType) As String
            ...
            'Convert text to valid string for that type
            Select Case Type
